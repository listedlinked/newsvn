...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NewSVN Core newsvn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  newsvn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded newsvn transaction") + "\n" +
                               "  newsvn-tx [options] -create [commands]   " + _("Create hex-encoded newsvn transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded newsvn transaction
