                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NewSVN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NewSVN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and newsvn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NewSVN Core"), this);
    aboutAction->setStatusTip(tr("Show information about NewSVN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NewSVN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NewSVN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NewSVN addresses"));
    ...
    openAction->setStatusTip(tr("Open a NewSVN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NewSVN Core help message to get a list with possible NewSVN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NewSVN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NewSVN network", "", count));
}
...
{
    QString strTitle = tr("NewSVN Core"); // default title
