...
/** Utility functions used by the NewSVN Qt UI.
 */
namespace GUIUtil
{
...
// Render NewSVN addresses in monospace font
...
// Parse "newsvn:" URI into recipient object, return true on successful parsing
