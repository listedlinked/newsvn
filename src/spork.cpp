...
// Copyright (c) 2016-2017 The AmsterdamCoin developers
...
// AmsterdamCoin: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // AmsterdamCoin: add to spork database.
