...
This mechanism has been integrated into Bitcore-Node-NewSVN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/NewSVN-Project/insight-api-newsvn#web-socket-api](https://github.com/NewSVN-Project/insight-api-newsvn#web-socket-api) 
* API: [https://github.com/NewSVN-Project/insight-api-newsvn#swifttx-transactions](https://github.com/NewSVN-Project/insight-api-newsvn#swifttx-transactions) 
...
By default, the NewSVN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NewSVN Core daemon:
