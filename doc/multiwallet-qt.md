...
In order to support loading of multiple wallets in newsvn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is newsvn.cpp.
...
Changes to newsvn.cpp
----------------------
newsvn.cpp is the entry point into newsvn-qt, and as such, will require some minor modifications to provide hooks for
