Contributing to NewSVN Core
============================

The NewSVN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NewSVN Core project, and is not to be
confused with overall NewSVN Network Protocol consensus changes.

Whether a pull request is merged into NewSVN Core rests with the project merge
...
Patches that change NewSVN consensus rules are considerably more involved than
...
Where a patch set proposes to change the NewSVN consensus, it must have been
...
The project leader is the release manager for each NewSVN Core release.
