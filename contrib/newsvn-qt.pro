...
RESOURCES += src/qt/newsvn.qrc src/qt/newsvn_locale.qrc

TRANSLATIONS += src/qt/locale/newsvn_bg.ts \
                src/qt/locale/newsvn_de.ts \
                src/qt/locale/newsvn_en.ts \
                src/qt/locale/newsvn_es.ts \
                src/qt/locale/newsvn_fi.ts \
                src/qt/locale/newsvn_fr.ts \
                src/qt/locale/newsvn_it.ts \
                src/qt/locale/newsvn_ja.ts \
                src/qt/locale/newsvn_pl.ts \
                src/qt/locale/newsvn_pt.ts \
                src/qt/locale/newsvn_ru.ts \
                src/qt/locale/newsvn_sk.ts \
                src/qt/locale/newsvn_sv.ts \
                src/qt/locale/newsvn_vi.ts \
                src/qt/locale/newsvn_zh_CN.ts \
                src/qt/locale/newsvn_zh_TW.ts
