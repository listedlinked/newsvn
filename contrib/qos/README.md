...
This means one can have an always-on newsvnd instance running, and another local newsvnd/newsvn-qt instance which connects to this node and receives blocks from it.
